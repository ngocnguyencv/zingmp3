...
const SearchAll: React.FC = () => {
  ...
  return (
    <div className='w-full flex flex-col gap-5 ml-[10px] px-[60px]'>
      ...
      {loading ? <ClipLoader color={'#D0021B'} loading={loading} size={30} />
        :
        <><div>
