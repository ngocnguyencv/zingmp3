    ...
    return (
        <div className='mt-12 px-[59px] relative lg:max-h-[480px] h-[820px]'>
            {loading ? <ClipLoader color={'#D0021B'} loading={loading} size={100} />
                :
                <><img src={imgchart} alt="" className='w-full object-cover rounded-md lg:max-h-[400px] h-[820px]' /><div className='absolute top-0 z-auto left-[59px] right-[59px] bottom-0 bg-[rgba(115,20,140,0.9)]'></div><div className='absolute top-0 z-auto left-[59px] right-[59px] bottom-0 p-5 flex flex-col gap-8'>
