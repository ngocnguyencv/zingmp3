...
const SidebarLeft = () => {
    ...
    return (
        <div className={`flex flex-col w-[248px] ${currentWidth < 1000 ? 'w-[60px]' : 'w-[240px]'} h-full flex-none justify-between bg-main-100 border`}>
            <div>
                ...
                <div>
                    <div className='flex flex-col py-4 border-b-2 overflow-y-scroll overflow-x-hidden scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-[#0F7070] max-h-[240px]'>
